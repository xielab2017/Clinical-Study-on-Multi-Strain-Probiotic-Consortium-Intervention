#S3C Box plot of relative abundance of joint optimal bacterial biomarkers selected by random forest algorithm in IBS group
tax <-c('[Ruminococcus]_gnavugroup','Blautia','Dorea','Enterobacteriaceae_unclassified','Subdoligranulum')
...
data$Group <- factor(data$Group,levels = c('IBS_before','IBS_after'))
