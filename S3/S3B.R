#S3B  IBS group beta diversity analysis, the following code only represents the graph due to p-value calculation, and p-value is calculated using paired t-test separately
MAE |>
  ...
  EMP_scatterplot(method='t.test',esti='Group',html_height=13,show='p12',ellipse=0.3,group_level=c('IBS_before','IBS_after'))
